...
const signalSchema = z.object({
    ...
    tp1: z.preprocess(v => (v === null ? undefined : v), z.coerce.number().positive().optional()),
    tp2: z.preprocess(v => (v === null ? undefined : v), z.coerce.number().positive().optional()),
    tp3: z.preprocess(v => (v === null ? undefined : v), z.coerce.number().positive().optional()),
...
function parseSignal(payload) {
    ...
    return Object.freeze({
        ...
        tp1: Number.isFinite(parsed.tp1) ? parsed.tp1 : undefined,
        tp2: Number.isFinite(parsed.tp2) ? parsed.tp2 : undefined,
        tp3: Number.isFinite(parsed.tp3) ? parsed.tp3 : undefined,
